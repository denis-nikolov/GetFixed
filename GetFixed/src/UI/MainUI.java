		...
		btnLeases.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				btnStartLease.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						contentPanel.removeAll();
						StartLeaseUI startLeaseUi = new StartLeaseUI(
								contentPanel, secondaryMenuPanel);
						startLeaseUi.make();
					}
				});
				...
				btnShowLease.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						contentPanel.removeAll();
						ShowLeaseUI showLeaseUi = new ShowLeaseUI(contentPanel,
								secondaryMenuPanel, btnShowLease);
						showLeaseUi.make();
					}
				});
				...
				btnEndLease.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						contentPanel.removeAll();
						EndLeaseUI endLeaseUi = new EndLeaseUI(contentPanel,
								secondaryMenuPanel, btnEndLease);
						endLeaseUi.make();
					}
				});
			...
			public void actionPerformed(ActionEvent e) {
				...
				btnShowProducts.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						ShowProductUI shwoProductUI = new ShowProductUI(
								contentPanel, secondaryMenuPanel,
								btnShowProducts);
						shwoProductUI.make();
					}
		...
		btnServices.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				btnShowService.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						contentPanel.removeAll();
						ShowServiceUI showServiceUI = new ShowServiceUI(
								contentPanel, secondaryMenuPanel,
								btnShowService);
						showServiceUI.make();
					}
			...
			public void actionPerformed(ActionEvent e) {
				...
				btnShowCustomer.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						ShowCustomerUI showCustomerUI = new ShowCustomerUI(
								contentPanel, secondaryMenuPanel,
								btnShowCustomer);
						showCustomerUI.make();
		...
		btnEmployees.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				btnShowEmployee.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						contentPanel.removeAll();
						ShowEmployeeUI showEmployeeUI = new ShowEmployeeUI(
								contentPanel, secondaryMenuPanel,
								btnAddEmployee);
						showEmployeeUI.make();
